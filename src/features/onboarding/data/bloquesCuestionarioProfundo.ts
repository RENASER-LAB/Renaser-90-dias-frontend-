...
> = {
  1: [{ campo: 'objetivoSmartCuerpo', aviso: 'Escribí tu objetivo SMART de Cuerpo a 90 días.' }],
  2: [
    { campo: 'criticoInterno', aviso: 'Escribí qué te dice tu crítico interno cuando fallas.' },
    { campo: 'creenciaLimitante', aviso: 'Escribí tu creencia limitante #1.' },
    { campo: 'definicionHoy', aviso: 'Escribí cómo te definís hoy, en una sola frase.' },
  ],
  3: [
    { campo: 'fraseParental', aviso: 'Escribí la frase de tu padre o madre que aún hoy te marca.' },
    { campo: 'fraseDineroInfancia', aviso: 'Escribí la frase sobre el dinero en tu infancia.' },
    { campo: 'vinculoPadre', aviso: 'Movés la barra para marcar tu vínculo hoy con tu padre.' },
    { campo: 'vinculoMadre', aviso: 'Movés la barra para marcar tu vínculo hoy con tu madre.' },
    { campo: 'mereceDinero', aviso: 'Movés la barra para marcar cuánto sentís que merecés ganar.' },
  ],
  4: [
    { campo: 'metaFacturacion', aviso: 'Escribí tu meta de facturación a 90 días (USD).' },
    { campo: 'productoEstrella', aviso: 'Describí tu producto o servicio estrella.' },
    { campo: 'clienteIdeal', aviso: 'Describí tu cliente ideal.' },
    { campo: 'enemigoPublico', aviso: 'Escribí tu Enemigo Público #1 del negocio.' },
    { campo: 'objetivoSmartNegocio', aviso: 'Escribí tu objetivo SMART de Negocio a 90 días.' },
  ],
  5: [
    { campo: 'unaSolaCosa', aviso: 'Escribí esa única cosa que haría de esta formación un éxito.' },
    { campo: 'bautizoProceso', aviso: 'Ponele nombre a tu reto personal de 90 días.' },
  ],
  6: [
    { campo: 'actividadDrena', aviso: 'Escribí qué actividad te drena más energía hoy.' },
    { campo: 'actividadRecarga', aviso: 'Escribí qué actividad te recarga más.' },
    { campo: 'ultimaVezVivo', aviso: 'Contá cuándo fue la última vez que te sentiste plenamente viv@.' },
  ],
  7: [
    { campo: 'miedoDetalle', aviso: 'Escribí de qué tenés más miedo en este momento.' },
    { campo: 'culpaDetalle', aviso: 'Escribí por qué cargás culpa, y con quién.' },
    { campo: 'verguenzaDetalle', aviso: 'Escribí de qué te avergonzás.' },
    { campo: 'miedoIntensidad', aviso: 'Movés la barra para marcar qué tan presente está el miedo.' },
    { campo: 'culpaIntensidad', aviso: 'Movés la barra para marcar qué tan presente está la culpa.' },
    { campo: 'verguenzaIntensidad', aviso: 'Movés la barra para marcar qué tan presente está la vergüenza.' },
  ],
  8: [
    { campo: 'decisionPostergada', aviso: 'Escribí qué decisión importante llevás postergando.' },
    { campo: 'nivelAnsiedad', aviso: 'Movés la barra para marcar tu nivel de ansiedad diaria.' },
  ],
};
