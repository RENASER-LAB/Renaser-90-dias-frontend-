...
export function ObjetivoNegocioScreen({ estado }: PropsPaso) {
  ...
  return (
    ...
    >
      ...
      <Row gap={8} align="flex-start">
        <Entrada valor={o.lineaBase} onCambiar={v => cambiar({ lineaBase: v })} placeholder={`Ej. ${o.moneda} 5,000`} numerico style={{ flex: 1 }} />
      </Row>
      ...
      <Entrada valor={o.resultadoDia90} onCambiar={v => cambiar({ resultadoDia90: v })} placeholder={`Ej. ${o.moneda} 15,000`} numerico />
